...
echo "<form method= 'POST' class='form-horizontal' action= 'nuevooestadodenuncia.php' id='estadodenuncia' title='estadodenuncia' >";
     echo "<div class='form-group'>";
         ...
         echo "<select class='form-control' name='Estado'>";
            ...
            echo "<option value= '2'>Completada</option>";
         echo " </select>";
         echo "</div>";
     echo "</div>";
     echo "<div class='form-group'>";
