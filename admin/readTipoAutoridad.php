...
echo "<td>".$c->getNombre()."</td>";
    ...
    echo "<td><a href='updateCategoria.php?id=".$c->getIdTipoAutoridad()."&nombre=".$c->getNombre()."'>Editar</a></td>"; 
  echo "<td><a href='deleteCategoria.php?id=".$c->getIdTipoAutoridad()."&nombre=".$c->getNombre()."'>Eliminar</a></td>"; 
  echo "</tr>"; 
