...
<?php
    ...
    echo "<div id='columna2'><a href='readArea.php'>TipoUsuario</div>";
    echo "<div id='columna3'><a href='readLote.php'>Autoridad</div>";
    echo "<div id='columna4'><a href='readCultivoLote.php'>Tipo de Autoridad</div>";
    echo "</div>";
    echo "<div id='contenidos'>";
    echo "<div id='columna1'><a href='readMedida.php'>Categorias</div>";
    echo "<div id='columna2'><a href='readLabor.php'>Denuncia</div>";
    echo "<div id='columna3'><a href='readPeriodo.php'>Comentario</div>";
    echo "<div id='columna4'><a href='readEmpleado.php'>Denunciante</div>";
    echo "</div>";
    echo "<div id='contenidos'>";
