...
<?php
include_once("DenuncianteCollector.php"); //llamar el collector de la otra tabla
...
<?php
include_once("CategoriaCollector.php"); //llamar el collector de la otra tabla
...
<?php
include_once("EstadoDenunciaCollector.php"); //llamar el collector de la otra tabla
...
<?php
include_once("AutoridadCollector.php"); //llamar el collector de la otra tabla
